...
int tolua_object_open (lua_State* tolua_S)
{
 ...
 TOLUA_DEF(TR3_SQUELCH);
 TOLUA_DEF(TR3_SH_FEAR);
 TOLUA_DEF(TR3_SKIP_FLAVOR);
 TOLUA_DEF(TR3_NO_FLAVOR);
...
void tolua_object_close (lua_State* tolua_S)
{
 ...
 TOLUA_UNDEF(TR3_SQUELCH);
 TOLUA_UNDEF(TR3_SH_FEAR);
 TOLUA_UNDEF(TR3_SKIP_FLAVOR);
 TOLUA_UNDEF(TR3_NO_FLAVOR);
