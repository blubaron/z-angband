...
int default_layout_win(term_data *data, int maxterms)
{
  ...
  if ((sx == 1024) && (sy == 768)) {
    ...
    data[0].font_want = string_make("8x13.fon");
    data[0].font_wid = 8;
    data[0].font_hgt = 13;
    data[0].tile_wid = 8;
    data[0].tile_hgt = 16;
    ...
    /* messages window */
    data[1].font_want = string_make("6x10.fon");
    data[1].font_wid = 6;
    data[1].font_hgt = 10;
    data[1].tile_wid = 6;
    data[1].tile_hgt = 10;
    ...
    /* inventory window */
    data[2].font_want = string_make("6x10.fon");
    data[2].font_wid = 6;
    data[2].font_hgt = 10;
    data[2].tile_wid = 6;
    data[2].tile_hgt = 10;
    ...
    /* monster list window */
    data[3].font_want = string_make("6x10.fon");
    data[3].font_wid = 6;
    data[3].font_hgt = 10;
    data[3].tile_wid = 6;
    data[3].tile_hgt = 10;
    ...
    /* object list window */
    data[4].font_want = string_make("6x10.fon");
    data[4].font_wid = 6;
    data[4].font_hgt = 10;
    data[4].tile_wid = 6;
    data[4].tile_hgt = 10;
    ...
    /* recall window */
    data[5].font_want = string_make("6x10.fon");
    data[5].font_wid = 6;
    data[5].font_hgt = 10;
    data[5].tile_wid = 6;
    data[5].tile_hgt = 10;
  ...
  arg_graphics = mode;
  //arg_graphics_nice = 1;
  tile_width_mult = mult_wid;
  tile_height_mult = mult_hgt;
