...
(void) tolua_S;	/* Hack - prevent compiler warnings */
 ...
 tolua_usertype(tolua_S,"player_spell_learned");
...
/* get function: realm of class  player_spell_learned */
static int toluaI_get_player_player_spell_learned_realm(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  tolua_pushnumber(tolua_S,(long)self->realm);
 return 1;
}

/* set function: realm of class  player_spell_learned */
static int toluaI_set_player_player_spell_learned_realm(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
...
/* get function: s_idx of class  player_spell_learned */
static int toluaI_get_player_player_spell_learned_s_idx(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  tolua_pushnumber(tolua_S,(long)self->s_idx);
 return 1;
}

/* set function: s_idx of class  player_spell_learned */
static int toluaI_set_player_player_spell_learned_s_idx(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->s_idx = ((byte)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: focus of class  player_spell_learned */
static int toluaI_get_player_player_spell_learned_focus(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  tolua_pushnumber(tolua_S,(long)self->focus);
 return 1;
}

/* set function: focus of class  player_spell_learned */
static int toluaI_set_player_player_spell_learned_focus(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->focus = ((byte)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: flags of class  player_spell_learned */
static int toluaI_get_player_player_spell_learned_flags(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
...
/* set function: flags of class  player_spell_learned */
static int toluaI_set_player_player_spell_learned_flags(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell_learned);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
...
/* get function: spell of class  player_spell_learned */
static int toluaI_get_player_player_spell_learned_spell(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell_learned);
 TOLUA_ARRAY_INDEX("player_spell_learned: spell",2);
 tolua_pushnumber(tolua_S,(long)self->spell[toluaI_index]);
 return 1;
}

/* set function: spell of class  player_spell_learned */
static int toluaI_set_player_player_spell_learned_spell(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell_learned);
 TOLUA_ARRAY_INDEX("player_spell_learned: spell",2);
  self->spell[toluaI_index] = ((byte)  tolua_getnumber(tolua_S,3,0));
 return 0;
}

/* get function: realm of class  player_spell */
static int toluaI_get_player_player_spell_realm(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell);
 TOLUA_ARRAY_INDEX("player_spell: realm",2);
 tolua_pushnumber(tolua_S,(long)self->realm[toluaI_index]);
 return 1;
}

/* set function: realm of class  player_spell */
static int toluaI_set_player_player_spell_realm(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell);
 TOLUA_ARRAY_INDEX("player_spell: realm",2);
  self->realm[toluaI_index] = ((byte)  tolua_getnumber(tolua_S,3,0));
 return 0;
}

/* get function: data of class  player_spell */
static int toluaI_get_player_player_spell_data(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell);
 TOLUA_ARRAY_INDEX("player_spell: data",PY_MAX_SPELLS);
 tolua_pushusertype(tolua_S,(void*)&self->data[toluaI_index],tolua_tag(tolua_S,"player_spell_learned"));
 return 1;
}

/* set function: data of class  player_spell */
static int toluaI_set_player_player_spell_data(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(player_spell);
 TOLUA_ARRAY_INDEX("player_spell: data",PY_MAX_SPELLS);
  self->data[toluaI_index] = *((player_spell_learned*)  tolua_getusertype(tolua_S,3,0));
 return 0;
}

/* get function: spell_max of class  player_spell */
static int toluaI_get_player_player_spell_spell_max(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell);
  tolua_pushnumber(tolua_S,(long)self->spell_max);
 return 1;
}

/* set function: spell_max of class  player_spell */
static int toluaI_set_player_player_spell_spell_max(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_spell);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->spell_max = ((byte)  tolua_getnumber(tolua_S,2,0));
 return 0;
}
...
/* get function: see_invis of class  player_timed */
static int toluaI_get_player_player_timed_see_invis(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->see_invis);
 return 1;
}

/* set function: see_invis of class  player_timed */
static int toluaI_set_player_player_timed_see_invis(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->see_invis = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}
...
/* get function: str of class  player_timed */
static int toluaI_get_player_player_timed_str(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: str of class  player_timed */
static int toluaI_set_player_player_timed_str(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->str = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: chr of class  player_timed */
static int toluaI_get_player_player_timed_chr(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->chr);
 return 1;
}

/* set function: chr of class  player_timed */
static int toluaI_set_player_player_timed_chr(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->chr = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sust_all of class  player_timed */
static int toluaI_get_player_player_timed_sust_all(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->sust_all);
 return 1;
}

/* set function: sust_all of class  player_timed */
static int toluaI_set_player_player_timed_sust_all(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sust_all = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: xtra_fast of class  player_timed */
static int toluaI_get_player_player_timed_xtra_fast(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->xtra_fast);
 return 1;
}

/* set function: xtra_fast of class  player_timed */
static int toluaI_set_player_player_timed_xtra_fast(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->xtra_fast = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: immune_acid of class  player_timed */
static int toluaI_get_player_player_timed_immune_acid(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: immune_acid of class  player_timed */
static int toluaI_set_player_player_timed_immune_acid(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->immune_acid = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: immune_fire of class  player_timed */
static int toluaI_get_player_player_timed_immune_fire(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: immune_fire of class  player_timed */
static int toluaI_set_player_player_timed_immune_fire(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->immune_fire = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: immune_cold of class  player_timed */
static int toluaI_get_player_player_timed_immune_cold(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: immune_cold of class  player_timed */
static int toluaI_set_player_player_timed_immune_cold(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->immune_cold = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: immune_elec of class  player_timed */
static int toluaI_get_player_player_timed_immune_elec(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: immune_elec of class  player_timed */
static int toluaI_set_player_player_timed_immune_elec(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->immune_elec = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sh_fire of class  player_timed */
static int toluaI_get_player_player_timed_sh_fire(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: sh_fire of class  player_timed */
static int toluaI_set_player_player_timed_sh_fire(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sh_fire = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sh_elec of class  player_timed */
static int toluaI_get_player_player_timed_sh_elec(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: sh_elec of class  player_timed */
static int toluaI_set_player_player_timed_sh_elec(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sh_elec = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sh_cold of class  player_timed */
static int toluaI_get_player_player_timed_sh_cold(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: sh_cold of class  player_timed */
static int toluaI_set_player_player_timed_sh_cold(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sh_cold = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sh_acid of class  player_timed */
static int toluaI_get_player_player_timed_sh_acid(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
...
/* set function: sh_acid of class  player_timed */
static int toluaI_set_player_player_timed_sh_acid(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sh_acid = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: sh_fear of class  player_timed */
static int toluaI_get_player_player_timed_sh_fear(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->sh_fear);
 return 1;
}

/* set function: sh_fear of class  player_timed */
static int toluaI_set_player_player_timed_sh_fear(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->sh_fear = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}
...
/* get function: luminosity of class  player_timed */
static int toluaI_get_player_player_timed_luminosity(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  tolua_pushnumber(tolua_S,(long)self->luminosity);
 return 1;
}

/* set function: luminosity of class  player_timed */
static int toluaI_set_player_player_timed_luminosity(lua_State* tolua_S)
{
  TOLUA_GET_SELF(player_timed);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->luminosity = ((s16b)  tolua_getnumber(tolua_S,2,0));
 return 0;
}
...
/* function: inc_oppose_conf */
static int toluaI_player_inc_oppose_conf00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_oppose_conf);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_oppose_conf(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_oppose_blind */
static int toluaI_player_inc_oppose_blind00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_oppose_blind);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_oppose_blind(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_luminosity */
static int toluaI_player_inc_luminosity00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_luminosity);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_luminosity(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
/* function: sp_player */
static int toluaI_player_sp_player00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(sp_player);
 } else {
  int num = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  sp_player(num);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_player_move_dun_level00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,3))
 {
  ...
  bool magic = ((bool)  tolua_getbool(tolua_S,2,0));
  move_dun_level(direction,magic);
 }
 return 0;
}
...
/* function: inc_etherealness */
static int toluaI_player_inc_etherealness00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_etherealness);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_etherealness(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_tim_str */
static int toluaI_player_inc_tim_str00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_tim_str);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_tim_str(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_tim_chr */
static int toluaI_player_inc_tim_chr00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_tim_chr);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_tim_chr(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_tim_sust_all */
static int toluaI_player_inc_tim_sust_all00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_tim_sust_all);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_tim_sust_all(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_xtra_fast */
static int toluaI_player_inc_xtra_fast00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_xtra_fast);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_xtra_fast(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_immune_acid */
static int toluaI_player_inc_immune_acid00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_immune_acid);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_immune_acid(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_immune_cold */
static int toluaI_player_inc_immune_cold00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_immune_cold);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_immune_cold(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_immune_elec */
static int toluaI_player_inc_immune_elec00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_immune_elec);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_immune_elec(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_immune_fire */
static int toluaI_player_inc_immune_fire00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_immune_fire);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_immune_fire(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_sh_fire */
static int toluaI_player_inc_sh_fire00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_sh_fire);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_sh_fire(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_sh_cold */
static int toluaI_player_inc_sh_cold00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_sh_cold);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_sh_cold(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_sh_acid */
static int toluaI_player_inc_sh_acid00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_sh_acid);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_sh_acid(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_sh_elec */
static int toluaI_player_inc_sh_elec00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_sh_elec);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_sh_elec(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_sh_fear */
static int toluaI_player_inc_sh_fear00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_sh_fear);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_sh_fear(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: inc_tim_invisible */
static int toluaI_player_inc_tim_invisible00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(inc_tim_invisible);
 } else {
  int v = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  inc_tim_invisible(v);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: query_timed */
static int toluaI_player_query_timed00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(query_timed);
 } else {
  int typ = ((int)  tolua_getnumber(tolua_S,1,0));
  s16b toluaI_ret = (s16b)  query_timed(typ);
  tolua_pushnumber(tolua_S,(long)toluaI_ret);
 }
 return 1;
}
...
/* function: set_timed */
static int toluaI_player_set_timed00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
 ...
 {
  TOLUA_ERR_FN(set_timed);
 } else {
  int typ = ((int)  tolua_getnumber(tolua_S,1,0));
  int v = ((int)  tolua_getnumber(tolua_S,2,0));
  cptr open_msg = ((cptr)  tolua_getstring(tolua_S,3,0));
  cptr shut_msg = ((cptr)  tolua_getstring(tolua_S,4,0));
  bool toluaI_ret = (bool)  set_timed(typ,v,open_msg,shut_msg);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
int tolua_player_open (lua_State* tolua_S)
{
 ...
 tolua_cclass(tolua_S,"player_spell_learned","");
 tolua_tablevar(tolua_S,"player_spell_learned","realm",toluaI_get_player_player_spell_learned_realm,toluaI_set_player_player_spell_learned_realm);
 tolua_tablevar(tolua_S,"player_spell_learned","s_idx",toluaI_get_player_player_spell_learned_s_idx,toluaI_set_player_player_spell_learned_s_idx);
 tolua_tablevar(tolua_S,"player_spell_learned","focus",toluaI_get_player_player_spell_learned_focus,toluaI_set_player_player_spell_learned_focus);
 tolua_tablevar(tolua_S,"player_spell_learned","flags",toluaI_get_player_player_spell_learned_flags,toluaI_set_player_player_spell_learned_flags);
 tolua_tablearray(tolua_S,"player_spell_learned","spell",toluaI_get_player_player_spell_learned_spell,toluaI_set_player_player_spell_learned_spell);
 tolua_cclass(tolua_S,"player_spell","");
 tolua_tablearray(tolua_S,"player_spell","realm",toluaI_get_player_player_spell_realm,toluaI_set_player_player_spell_realm);
 tolua_tablearray(tolua_S,"player_spell","data",toluaI_get_player_player_spell_data,toluaI_set_player_player_spell_data);
 tolua_tablevar(tolua_S,"player_spell","spell_max",toluaI_get_player_player_spell_spell_max,toluaI_set_player_player_spell_spell_max);
 ...
 tolua_tablevar(tolua_S,"player_timed","see_invis",toluaI_get_player_player_timed_see_invis,toluaI_set_player_player_timed_see_invis);
 ...
 tolua_tablevar(tolua_S,"player_timed","str",toluaI_get_player_player_timed_str,toluaI_set_player_player_timed_str);
 tolua_tablevar(tolua_S,"player_timed","chr",toluaI_get_player_player_timed_chr,toluaI_set_player_player_timed_chr);
 tolua_tablevar(tolua_S,"player_timed","sust_all",toluaI_get_player_player_timed_sust_all,toluaI_set_player_player_timed_sust_all);
 tolua_tablevar(tolua_S,"player_timed","xtra_fast",toluaI_get_player_player_timed_xtra_fast,toluaI_set_player_player_timed_xtra_fast);
 tolua_tablevar(tolua_S,"player_timed","immune_acid",toluaI_get_player_player_timed_immune_acid,toluaI_set_player_player_timed_immune_acid);
 tolua_tablevar(tolua_S,"player_timed","immune_fire",toluaI_get_player_player_timed_immune_fire,toluaI_set_player_player_timed_immune_fire);
 tolua_tablevar(tolua_S,"player_timed","immune_cold",toluaI_get_player_player_timed_immune_cold,toluaI_set_player_player_timed_immune_cold);
 tolua_tablevar(tolua_S,"player_timed","immune_elec",toluaI_get_player_player_timed_immune_elec,toluaI_set_player_player_timed_immune_elec);
 tolua_tablevar(tolua_S,"player_timed","sh_fire",toluaI_get_player_player_timed_sh_fire,toluaI_set_player_player_timed_sh_fire);
 tolua_tablevar(tolua_S,"player_timed","sh_elec",toluaI_get_player_player_timed_sh_elec,toluaI_set_player_player_timed_sh_elec);
 tolua_tablevar(tolua_S,"player_timed","sh_cold",toluaI_get_player_player_timed_sh_cold,toluaI_set_player_player_timed_sh_cold);
 tolua_tablevar(tolua_S,"player_timed","sh_acid",toluaI_get_player_player_timed_sh_acid,toluaI_set_player_player_timed_sh_acid);
 tolua_tablevar(tolua_S,"player_timed","sh_fear",toluaI_get_player_player_timed_sh_fear,toluaI_set_player_player_timed_sh_fear);
 tolua_tablevar(tolua_S,"player_timed","invis",toluaI_get_player_player_timed_invis,toluaI_set_player_player_timed_invis);
 tolua_tablevar(tolua_S,"player_timed","luminosity",toluaI_get_player_player_timed_luminosity,toluaI_set_player_player_timed_luminosity);
 ...
 TOLUA_FUN(inc_oppose_conf,toluaI_player_inc_oppose_conf00);
 TOLUA_FUN(inc_oppose_blind,toluaI_player_inc_oppose_blind00);
 TOLUA_FUN(inc_luminosity,toluaI_player_inc_luminosity00);
 ...
 TOLUA_FUN(sp_player,toluaI_player_sp_player00);
 ...
 TOLUA_FUN(inc_etherealness,toluaI_player_inc_etherealness00);
 TOLUA_FUN(inc_tim_str,toluaI_player_inc_tim_str00);
 TOLUA_FUN(inc_tim_chr,toluaI_player_inc_tim_chr00);
 TOLUA_FUN(inc_tim_sust_all,toluaI_player_inc_tim_sust_all00);
 TOLUA_FUN(inc_xtra_fast,toluaI_player_inc_xtra_fast00);
 TOLUA_FUN(inc_immune_acid,toluaI_player_inc_immune_acid00);
 TOLUA_FUN(inc_immune_cold,toluaI_player_inc_immune_cold00);
 TOLUA_FUN(inc_immune_elec,toluaI_player_inc_immune_elec00);
 TOLUA_FUN(inc_immune_fire,toluaI_player_inc_immune_fire00);
 TOLUA_FUN(inc_sh_fire,toluaI_player_inc_sh_fire00);
 TOLUA_FUN(inc_sh_cold,toluaI_player_inc_sh_cold00);
 TOLUA_FUN(inc_sh_acid,toluaI_player_inc_sh_acid00);
 TOLUA_FUN(inc_sh_elec,toluaI_player_inc_sh_elec00);
 TOLUA_FUN(inc_sh_fear,toluaI_player_inc_sh_fear00);
 TOLUA_FUN(inc_tim_invisible,toluaI_player_inc_tim_invisible00);
 TOLUA_FUN(query_timed,toluaI_player_query_timed00);
 TOLUA_FUN(set_timed,toluaI_player_set_timed00);
 return 1;
}
/* Close function */
void tolua_player_close (lua_State* tolua_S)
{
 ...
 TOLUA_UNDEF(player_spell_learned);
 ...
 TOLUA_UNDEF(inc_oppose_conf);
 TOLUA_UNDEF(inc_oppose_blind);
 TOLUA_UNDEF(inc_luminosity);
 ...
 TOLUA_UNDEF(inc_etherealness);
 TOLUA_UNDEF(inc_tim_str);
 TOLUA_UNDEF(inc_tim_chr);
 TOLUA_UNDEF(inc_tim_sust_all);
 TOLUA_UNDEF(inc_xtra_fast);
 TOLUA_UNDEF(inc_immune_acid);
 TOLUA_UNDEF(inc_immune_cold);
 TOLUA_UNDEF(inc_immune_elec);
 TOLUA_UNDEF(inc_immune_fire);
 TOLUA_UNDEF(inc_sh_fire);
 TOLUA_UNDEF(inc_sh_cold);
 TOLUA_UNDEF(inc_sh_acid);
 TOLUA_UNDEF(inc_sh_elec);
 TOLUA_UNDEF(inc_sh_fear);
 TOLUA_UNDEF(inc_tim_invisible);
 TOLUA_UNDEF(query_timed);
 TOLUA_UNDEF(set_timed);
}
