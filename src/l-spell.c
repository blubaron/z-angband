...
/* function: project_m */
static int toluaI_spell_project_m00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,3,LUA_TNUMBER,0) ||
     ...
     !tolua_isnoobj(tolua_S,7))
 {
  ...
  int dam = ((int)  tolua_getnumber(tolua_S,5,0));
  int typ = ((int)  tolua_getnumber(tolua_S,6,0));
  bool toluaI_ret = (bool)  project_m(who,r,x,y,dam,typ);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_spell_detect_traps00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,2))
 {
  ...
  bool ident = ((bool)  tolua_getbool(tolua_S,1,0));
  bool toluaI_ret = (bool)  detect_traps(ident);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_spell_call_chaos00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,2))
 {
  ...
  byte power = ((byte)  tolua_getnumber(tolua_S,1,0));
  call_chaos(power);
 }
 return 0;
}
...
static int toluaI_spell_lite_line00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,3))
 {
  ...
  bool toluaI_ret = (bool)  lite_line(dir,dam);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_spell_brand_weapon00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,2))
 {
  ...
  bool toluaI_ret = (bool)  brand_weapon(brand_type);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_spell_enchant00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,5))
 {
  ...
  byte power = ((byte)  tolua_getnumber(tolua_S,4,0));
  bool toluaI_ret = (bool)  enchant(o_ptr,n,eflag,power);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
static int toluaI_spell_enchant_spell00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,5))
 {
  ...
  byte power = ((byte)  tolua_getnumber(tolua_S,4,0));
  bool toluaI_ret = (bool)  enchant_spell(num_hit,num_dam,num_ac,power);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
/* function: ident_scroll */
static int toluaI_spell_ident_scroll00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(ident_scroll);
 } else {
  int k_idx = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  ident_scroll(k_idx);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
/* function: do_stasis */
static int toluaI_spell_do_stasis00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
     !tolua_istype(tolua_S,3,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,4))
 {
  TOLUA_ERR_FN(do_stasis);
 } else {
  int x = ((int)  tolua_getnumber(tolua_S,1,0));
  int y = ((int)  tolua_getnumber(tolua_S,2,0));
  int dam = ((int)  tolua_getnumber(tolua_S,3,0));
  bool toluaI_ret = (bool)  do_stasis(x,y,dam);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
int tolua_spell_open (lua_State* tolua_S)
{
 ...
 TOLUA_DEF(GF_MAKE_LAVA);
 TOLUA_DEF(GF_MAKE_WATER);
 TOLUA_DEF(GF_IDENT);
 TOLUA_DEF(GF_CONTROL_EVIL);
 TOLUA_DEF(GF_TELE_ATTACK);
 TOLUA_DEF(GF_IMPRISON);
 TOLUA_DEF(GF_CLONE_PET);
 TOLUA_DEF(GF_KILL_CURSE);
 TOLUA_DEF(GF_PETRIFY);
 TOLUA_DEF(GF_SILENCE);
 TOLUA_DEF(GF_TERRAFORM);
 ...
 TOLUA_DEF(PROJECT_ROCK);
 TOLUA_DEF(PROJECT_SHORT);
 TOLUA_FUN(project,toluaI_spell_project00);
 TOLUA_FUN(project_m,toluaI_spell_project_m00);
 ...
 TOLUA_FUN(project_hook,toluaI_spell_project_hook00);
 ...
 TOLUA_FUN(do_stasis,toluaI_spell_do_stasis00);
...
void tolua_spell_close (lua_State* tolua_S)
{
 ...
 TOLUA_UNDEF(GF_MAKE_LAVA);
 TOLUA_UNDEF(GF_MAKE_WATER);
 TOLUA_UNDEF(GF_IDENT);
 TOLUA_UNDEF(GF_CONTROL_EVIL);
 TOLUA_UNDEF(GF_TELE_ATTACK);
 TOLUA_UNDEF(GF_IMPRISON);
 TOLUA_UNDEF(GF_CLONE_PET);
 TOLUA_UNDEF(GF_KILL_CURSE);
 TOLUA_UNDEF(GF_PETRIFY);
 TOLUA_UNDEF(GF_SILENCE);
 TOLUA_UNDEF(GF_TERRAFORM);
 ...
 TOLUA_UNDEF(PROJECT_ROCK);
 TOLUA_UNDEF(PROJECT_SHORT);
 TOLUA_UNDEF(project);
 TOLUA_UNDEF(project_m);
